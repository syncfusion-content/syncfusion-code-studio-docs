...
The [User Settings](/code-studio/reference/configure-properties/usersettings) page has been redesigned to provide a more modern, consolidated interface that makes managing Syncfusion Code simpler and more intuitive. The new UI brings everything together in one place with clear categories and instant changes. 
