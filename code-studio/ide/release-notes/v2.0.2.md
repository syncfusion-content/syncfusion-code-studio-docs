...
Description: Syncfusion Code with advanced agent customization and integrated browser. Packed with new features designed to help you build faster and deliver higher-quality outcomes.
platform: syncfusion-code-studio
tocname: code-studio-ide-toc
---

# What's New in v2.0.2
We've enhanced Syncfusion Code with powerful new agent customization capabilities, including Agent Skills, Agent Hooks, and an integrated browser experience. Each update is designed to help you build faster, enforce standards consistently, and deliver higher-quality outcomes.

## Breaking Changes
### Semantic Tool Removed
Due to slow latency in semantic queries, the semantic tool has been fully removed from Syncfusion Code.

### UI Builder Tool Removed
The UI Builder tool has been removed from Syncfusion Code.

### BYOK Removed
- BYOK has been removed from the Syncfusion Code Enterprise Server dashboard. It is supported only in the IDE chat view, not in the server dashboard.
...
### Integrated Browser
Browse web applications without leaving Syncfusion Code. The new integrated browser overcomes limitations of the Simple Browser by providing full authentication support, DevTools, and seamless AI integration.
...
### Dark Mode Support
The **Dark Mode Support feature** in Syncfusion Code Enterprise Server introduces a unified dark themed interface designed for developers and administrators who prefer working in low light or visually minimal environments. This theme applies consistently to Dashboard, User and Teams, Fallback Policy, Budget and Settings.

<img src="./releasenotes-images/darktheme2.png" alt="release notes" >

## Improvements
### Syncfusion Code Usage UI Update
- Improved the Syncfusion Code usage interface to display users' remaining credits for better tracking.
...
- Ensured Syncfusion Code themes are properly applied across the Settings page and MCP sections.
