...
## Verification: How to Verify Your Templates Are Working

After you create your first template, test it:

**For Custom Prompts:**

- Press `/` in chat and find your prompt
- Does it appear in the list?
- Run it on a real task — does it produce good results?

**For Custom Agents:**

- Click the agent dropdown
- Does your agent appear in the list?
- Switch to it and run a task — does it follow your instructions?

**For Custom Instructions:**

- Add your instruction file
- Open a file that matches your rules
- Open chat — is your instruction referenced automatically?

**For Skills:**

- Create your skill folder and SKILL.md
- Give the request in the chat that matches with the skill
- Do the instructions load correctly?
