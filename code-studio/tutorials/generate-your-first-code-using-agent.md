...
This tutorial guides you through using Agent mode in Syncfusion Code Studio. Agent mode enables autonomous AI-powered coding capabilities, allowing you to generate, review, and manage code changes with AI assistance. You'll learn how to enable Agent mode, instruct the AI with prompts, review proposed changes, and utilize checkpoints to manage code iterations. To learn more about agent mode, visit [agent](/code-studio/features/agent).
...
3. Choose **Agent Mode** from the dropdown menu.
   - Agent Mode enables autonomous coding capabilities, allowing the AI to analyze, edit, and manage your codebase.
4. Confirm that Agent Mode is active by checking for the tick mark status indicator in the interface.
   <img src="./tutorials-images/firstagentchange1.png" alt="enable agent" />
...
3. The Agent will then:
   ...
   <img src="./tutorials-images/firstagentchange2.png" alt="agent processing" />
...
### 4. Review the Code Change Summary
...
For more details about checkpoints, see [Checkpoints Feature](/code-studio/features/checkpoints).

## Next Steps

Now that you've successfully generated your first code change using Agent mode:

- Explore **advanced prompting techniques** to generate more complex code changes
- Learn about **checkpoint management** to efficiently manage your project versions at [Checkpoints](/code-studio/features/checkpoints)
- Review the **Agent mode features** guide at [Agent](/code-studio/features/agent) for additional capabilities
- Try creating code changes in different project types and languages to become more familiar with Agent mode
