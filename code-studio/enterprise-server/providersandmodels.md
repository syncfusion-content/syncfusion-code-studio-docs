...
4. Click **“Add”** to save the provider.
  <img src="./enterprise-images/updated-screenshots/edit-llm.png" alt="Provider" />
...
4. In the form:
  ...
  <img src="./enterprise-images/updated-screenshots/add-model.png" alt="provider" /> 
5. Click Add to include the model in your BYOK model list.
  <img src="./enterprise-images/updated-screenshots/add-model-2.png" alt="provider" />
