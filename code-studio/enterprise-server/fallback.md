...
<img src="./enterprise-images/updated-screenshots/fallback-policy.png" alt="fallback"  />
...
4. Add models in the desired Fallback Order:
  ...
  <img src="./enterprise-images/updated-screenshots/edit-fallback-policy.png" alt="fallback"  />
