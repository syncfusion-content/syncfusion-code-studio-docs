...
- **Configuration Files:** Workspace rules, prompt files, and previously installed MCP servers from prior versions are not accessible. Please refer to the documentation for guidance on reconfiguring these settings.
