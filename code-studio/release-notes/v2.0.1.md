...
description: Code Studio v2.0.1 introduces Agent Skills, Agent Hooks, an Integrated Browser, new themes, new chat models, performance improvements, and critical bug fixes for a more productive AI-powered coding experience.
...
- Refined Pure React and MAUI platform prompts for improved output quality.
