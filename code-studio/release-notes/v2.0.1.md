...
### Gemini 3 Pro (Preview) Chat Model Removed
Gemini 3 Pro (Preview) has been deprecated due to a provider-side model retirement notification.
...
- Team Owners are **not limited to a single team**. They can be assigned to multiple teams, **except their own**. They have **Admin-level access** only within the teams they manage.
...
<img src="./releasenotes-images/darktheme1.png" alt="release notes" >
