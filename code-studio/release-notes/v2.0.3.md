...
## Bug Fixes
- Fixed issue in Code Studio where users received no response when using the Claude model for longer-running prompts.Ensured chat reliably returns a response even when processing time is higher.