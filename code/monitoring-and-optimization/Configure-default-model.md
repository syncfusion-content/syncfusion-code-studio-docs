...
* Syncfusion Code is installed and configured on your system. If you have not yet downloaded Syncfusion Code, refer to the [Syncfusion Code Install and Configure](/code-studio/getting-started/install-and-configuration)
...
* Go to the [Models](https://app.sfcodestudio.com/models) section and click Manage Default Settings.
 ...
 >**Note**: If you have not configured your model, please refer to [Configure LLM Providers and Models in Syncfusion Code](/code-studio/teams-and-enterprise/providersandmodels) for guidance on adding models.


    
<img src="./monitoring-and-optimization-images/dashboard-models.png" alt="models-section">
...
* After selecting Manage Default settings, a popup appears with options to configure the default models for Chat and Autocomplete.
    ...
    <img src="./monitoring-and-optimization-images/dashboard-manage-models.png" alt="default-models-popup">
