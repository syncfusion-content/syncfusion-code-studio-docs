...
- **Budget configured:** Refer to the [Create Budget](/code-studio/teams-and-enterprise/createbudget) guide to create and assign a budget for the team or the individual user before setting an alert.
