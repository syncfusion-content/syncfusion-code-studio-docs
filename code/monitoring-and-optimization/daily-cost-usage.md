...
- Credits spent for todayâ€™s usage
...
- The dashboard refreshes to show todayâ€™s credit usage.

### Step 6: Select the chat session from the Filter.
<img src="./monitoring-and-optimization-images/chat-session.png">
- The dashboard refreshes to show todayâ€™s credit usage for the chat session.
...
<img src="./monitoring-and-optimization-images/cost-usage.png">
...
<img src="./monitoring-and-optimization-images/Token-consumed.png">
