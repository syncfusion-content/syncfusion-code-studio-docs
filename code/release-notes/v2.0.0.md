...
## New Features
### Plan Mode
The Syncfusion Code IDE now introduces [Plan Mode](/code-studio/features/plan), a smarter way to start coding with confidence. Instead of jumping straight into implementation, Plan Mode helps you research tasks, outline requirements, and break work into clear steps. You'll receive a draft plan to review, edit, or approve—ensuring nothing changes in your code until you're ready. By beginning with a clear plan, you reduce mistakes, stay organized, and make complex projects easier to manage. 
 
<img src="./releasenotes-images/PlanMode.gif" alt="release notes" >

### Custom Agents
[Custom Agents](/code-studio/customization/custom-agents) let you set up the AI to act like different roles for your project. You can make one agent a security reviewer, performance checker, or a solution architect. Each agent follows its own rules and tools, so the AI gives answers that fit the job. You can also switch between agents with one click—like moving from coding to performance checking or handing off to a code reviewer—while keeping all the context.
...
### Custom Instructions
Easily tailor the AI assistant to your project needs with [Custom Instructions](/code-studio/customization/custom-instructions). Define coding standards, architecture preferences, and project-specific guidelines, so the assistant delivers consistent, context-aware responses without assumptions. This ensures smoother collaboration. 
 
<img src="./releasenotes-images/custom-instructions.png" alt="release notes" >

### Custom Prompts
Boost productivity with reusable prompt files for common development tasks. From code generation to reviews and scaffolding, [Custom Prompts](/code-studio/customization/custom-prompt)  let you build a library of standardized workflows that can be run directly in chat—ensuring consistency and faster execution across projects.

<img src="./releasenotes-images/custom-prompt.png" alt="release notes" >
 
### Add Contexts
Syncfusion Code now introduces a redesigned [Add Context](/code-studio/features/add-context) experience that makes it simple to give the AI the right information. You can attach files, folders, problems, symbols, screenshots, or tools directly from the chat. 
...
The [User Settings](/code-studio/customization/usersettings) page has been redesigned to provide a more modern, consolidated interface that makes managing Syncfusion Code simpler and more intuitive. The new UI brings everything together in one place with clear categories and instant changes. 
