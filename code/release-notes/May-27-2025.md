---
title: Syncfusion Code Studio Release Notes - May 27, 2025
Desciption: Initial release of Code Studio Agent Mode, introducing autonomous code analysis, editing, and execution features to enhance developer productivity.
platform: syncfusion-code-studio
---

# Release Updates - May 27, 2025

- **Chat mode**: Interact with Code Studio using natural language to get code suggestions, explanations, and assistance in real time.
- **Agent mode**: Enables Code Studio to autonomously analyze your codebase, plan and execute changes, and use tools to automate complex development tasks with minimal input.
...
- **Tool integration**: Seamlessly integrates with your IDE and development tools, providing a unified workflow for searching, editing, and running commands directly from Code Studio.
...
- **Multi Model**: Switch between different AI models to tailor Code Studio’s responses and capabilities to your needs.
...
- **MCP server integration**: Connect Code Studio with your Model Context Protocol (MCP) pull data fron anywhere.
