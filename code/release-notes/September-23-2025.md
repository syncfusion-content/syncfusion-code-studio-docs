---
title: Syncfusion Code Studio Release Notes - September 23, 2025
Description: Enhanced Code Studio with improved context usage UI, extension management, terminal, and various new features and bug fixes.
platform: syncfusion-code-studio
---

# Release Updates - September 23, 2025

- **Code Studio built for enterprise:** Confidently scale AI development across your organization with centralized control, security, and visibility. For more details, please refer to our documentation on [enterprise server](/code/teams-and-enterprise/getting-started).
...
- **Agent max request confirmation:** User settings now request confirmation to continue or stop streaming after reaching the maximum allowed requests.For more details, please refer to our documentation on [user settings](/code/customization/usersettings).

<img src="./releasenotes-images/agentmaxrequest.png" alt="release notes" >

- **Info icon in user settings:** An info icon has been added to the user settings options, allowing users to access detailed information about each setting directly from the interface.For more details, please refer to our documentation on [user settings](/code/customization/usersettings).
...
- **Feedback section:** A new feedback section is available under the help menu in the title bar, linking directly to the Code Studio feedback page.
