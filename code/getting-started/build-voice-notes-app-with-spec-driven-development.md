...
For more information about OpenSpec, visit our [Using OpenSpec in Syncfusion Code](/code/integrations-and-apis/using-openspec-inside-syncfusion-code) guide.
...
1. **Create a new workspace**:
   ...
   - Open that 'voice-notes-app'  as your workspace in Syncfusion Code by clicking **File** -> **Open Folder**
