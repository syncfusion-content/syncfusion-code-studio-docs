...
*Learn more about [Autocomplete](/code/agentic-toolbox/core-capabilities/autocomplete)*
...
*Learn more about [Ask](/code/agentic-toolbox/chat-interactions/ask)*
...
*Learn more about [Edit](/code/agentic-toolbox/chat-interactions/edit)*
...
*Learn more about [Agent](/code/agentic-toolbox/chat-interactions/agent)*
...
*Learn more about [Plan](/code/agentic-toolbox/chat-interactions/plan)*
...
*Learn more about [Inline Chat](/code/agentic-toolbox/chat-interactions/inlinechat)*
...
*Learn more about [Add Context](/code/agentic-toolbox/chat-interactions/add-context)*

## Next Steps

Now that you've explored the basics:

- Learn how to create your first automated change with [Agent](/code/agentic-toolbox/chat-interactions/agent).  
