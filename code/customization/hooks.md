...
- [Custom Instructions](/code/reference/configure-properties/custom-instructions)
- [Tools Support](/code/reference/configure-properties/toolssupport)
- [Enhancing Security Reviews and Code Quality with Automated Hooks in Code Studio](/code/tutorials/enhance-security-with-hooks)
- [Custom Agents](/code/reference/configure-properties/custom-agents)