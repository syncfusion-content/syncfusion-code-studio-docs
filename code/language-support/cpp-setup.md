---
title: "C++ Development Setup in BoldCreate"
description: "Complete guide to set up C++ development environment with compiler installation, configuration, and AI-assisted coding in BoldCreate"
...
# C++ Development Setup in BoldCreate

## Overview

BoldCreate provides intelligent AI-powered assistance for C++ development, helping you write, debug, and optimize C++ code faster. Whether you're building system applications, game engines, or performance-critical software, BoldCreate's AI features work alongside your C++ compiler to enhance your productivity.

This guide walks you through setting up a complete C++ development environment—from installing compilers to writing your first AI-assisted C++ program. Once configured, you'll be able to leverage BoldCreate's autocomplete, debugging assistance, code explanations, and smart refactoring for all your C++ projects.
...
- Write and run your first C++ program in BoldCreate

## Download and Install C++ Compiler

### Windows

This guide uses MinGW-w64, which provides the GCC compiler for Windows. It's lightweight, open-source, and works perfectly with BoldCreate.
...
## Configure C++ in BoldCreate

With the compiler installed, the next step is to set up BoldCreate to work seamlessly with your C++ environment. This involves installing an extension for debugging and configuring build and debug tasks.

> **Why Not Use Microsoft's C/C++ Extension?**
>
> BoldCreate is a fork of Visual Studio Code with enhanced AI capabilities. BoldCreate cannot use certain Microsoft proprietary extensions due to licensing restrictions. 
>
> Microsoft's C/C++ extension (`ms-vscode.cpptools`) is only licensed for use in official VS Code builds. Attempting to install it in BoldCreate will result in errors or the extension simply won't function.
>
...
3. Search for **"CodeLLDB"** (by vadimcn)
    ...
    <img src="language-images/cpp-extension-install.png" alt="BoldCreate Extensions view showing CodeLLDB extension with Install button" />
...
With CodeLLDB installed, let's set up a build task so you can compile your C++ code directly from BoldCreate without switching to the command line.
...
> **Key Points:**
> - `"type": "lldb"` tells BoldCreate to use CodeLLDB for debugging
...
1. In BoldCreate, create a new file: `hello.cpp`
2. You can write the code yourself or ask BoldCreate to help:
   ...
   **Try this prompt in BoldCreate Chat:**
   ...
   ```
3. BoldCreate will generate a basic C++ code.

    <img src="language-images/cpp-ai-generate.gif" alt="BoldCreate chat showing AI generating a C++ hello world program" />

---

## Debug Your C++ Code

Debugging is where BoldCreate truly shines. Let's walk through setting breakpoints and inspecting your program as it runs.
...
2. A red dot will appear
    ...
    <img src="language-images/cpp-breakpoint.png" alt="BoldCreate editor showing a red breakpoint dot next to line numbers in C++ code" />
...
4. While debugging, you can:
   ...
   - Examine the call stack in the **Call Stack** panel
    ...
    <img src="language-images/cpp-debugging-breakpoint.gif" alt="BoldCreate debug view showing Variables, Watch, and Call Stack panels" />

---

## Next Steps

Now that Your C++ development environment is now fully configured in BoldCreate. Here's what you can explore next:
...
- Restart BoldCreate if the terminal was already open
