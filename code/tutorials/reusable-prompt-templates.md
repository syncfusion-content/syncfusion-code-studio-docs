...
To create and setup the custom prompt, see [Custom Prompts](/code/customization/custom-prompt) for detailed steps.
...
To create and setup the agents, see [Custom Agents](/code/customization/custom-agents) for detailed steps.
...
To create and setup the custom instructions, see [Custom Instruction](/code/customization/custom-instructions) for detailed steps.
...
To create and setup the skills, see [Skills](/code/customization/skills) for detailed steps.
