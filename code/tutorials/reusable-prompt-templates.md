...
To create and setup the custom prompt, see [Custom Prompts](/code/reference/configure-properties/custom-prompt) for detailed steps.
...
To create and setup the agents, see [Custom Agents](/code/reference/configure-properties/custom-agents) for detailed steps.
...
To create and setup the custom instructions, see [Custom Instruction](/code/reference/configure-properties/custom-instructions) for detailed steps.
...
To create and setup the skills, see [Skills](/code/reference/configure-properties/skills) for detailed steps.
