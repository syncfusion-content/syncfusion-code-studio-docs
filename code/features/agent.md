...
<img src="./feature-images/auto-configure1.png" alt="Syncfusion Code Settings" />
...
- [Custom Agent](/code/reference/configure-properties/custom-agents): Define rules/instructions for consistent, constrained behavior.