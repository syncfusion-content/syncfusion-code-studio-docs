...
- **[Hooks](/code-studio/customize/hooks)** — Lets you create custom approval rules (advanced feature). Example: "Always require approval before editing production files, but auto-approve test files."
