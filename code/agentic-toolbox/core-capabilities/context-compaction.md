...
## Related Features
- [Agent Mode](/code-studio/agentic-toolbox/chat-interactions/agent) - Long agent sessions can accumulate a large amount of context. Use `/compact` to trim the history and keep the agent focused on the current task.