...
<img src="../agentic-toolbox-images/context-command.png" alt="Context Compaction Command" />

The agent will analyze the conversation and automatically compact the context by summarizing or removing older messages.

<img src="../agentic-toolbox-images/context-compaction.png" alt="Context Compaction in Progress" />
...
<img src="../agentic-toolbox-images/context-result.png" alt="Context Compaction Result" />
...
## Related Features
- [Agent Mode](/code/agentic-toolbox/chat-interactions/agent) - Long agent sessions can accumulate a large amount of context. Use `/compact` to trim the history and keep the agent focused on the current task.