---
title: Accelerating Code Reviews - Instant AI-Driven Insights with BoldCreate
description: Learn how to get instant, intelligent code reviews in BoldCreate using Git diffs, custom review agents, and inline suggestions to catch bugs before they ship.
...
# Accelerating Code Reviews: Instant AI-Driven Insights with BoldCreate
...
In a few minutes, you'll learn three powerful ways to review your code instantly in BoldCreate—catching bugs, security issues, and quality problems before they ever reach a pull request. No more waiting. No more bottlenecks.
...
**#changes** — A special tool in BoldCreate that shares your uncommitted Git changes with the AI so it can review everything you modified in one go.
...
2. Open the Chat panel in BoldCreate (Ctrl+Shift+I on Windows, Cmd+Shift+I on macOS).
...
For detailed steps on creating custom agents, see [Custom Agents](/code/customize/custom-agents).
