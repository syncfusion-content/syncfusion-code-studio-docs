...
description: Learn how to use Agent mode in BoldCreate to generate, review, and manage code changes with AI assistance.
...
- Switch on Agent mode in BoldCreate (it's just one click!)
...
1. **Open BoldCreate** with your project or any folder you'd like to experiment with.
...
4. **Verify it's active** by looking for a checkmark or indicator next to Agent Mode in the interface. You'll know it's working when the mode selector shows "Agent Mode" is active.
   ...
   <img src="../agentic-toolbox-images/firstagentchange1.png" alt="Enable Agent Mode" />
...
- You can restore any checkpoint if you want to "undo" several changes at once
   ...
   <img src="../agentic-toolbox-images/firstagentchange4.png" alt="Checkpoints" />
