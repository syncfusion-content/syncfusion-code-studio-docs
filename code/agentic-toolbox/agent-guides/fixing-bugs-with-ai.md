---
title: Fixing Bugs in Seconds Smart Error Resolution with BoldCreate AI
description: Learn how BoldCreate AI instantly identifies and resolves errors, helping developers fix bugs in seconds with AI-powered quick fixes and smart debugging.
platform: syncfusion-code-studio
keywords: bug-fixing, error-resolution, quick-fix, problems-panel, context, agent-mode, attachment
---

# Fixing Bugs in Seconds: Smart Error Resolution with BoldCreate AI

## Overview

Tracking down a bug can take significant time, especially when the root cause is a simple typo, a missing import, or a type mismatch buried across multiple files. BoldCreate AI helps you identify and resolve these errors quickly by surfacing AI-powered fixes directly in your editor.

This tutorial walks you through three approaches to fixing bugs with BoldCreate AI: using hover quick fixes for single errors, sending problems from the **Problems panel** as context to the AI agent, and attaching files so the AI understands your broader codebase before suggesting a fix.
...
1. Open your project which has errors in BoldCreate.

2. Move your mouse cursor over any red underlined error in your code. BoldCreate AI displays the following options:
...
3. Click **Quick Fix** to apply the fix instantly.
   ...
   <img src="../agentic-toolbox-images/Error-options.png" alt="Quick Fix options displayed on hover over a red underlined error in the editor" />
...
1. Open the **Chat Panel** by pressing `Ctrl+Alt+B` (Windows/Linux) or `Cmd+Alt+B` (Mac), or click the BoldCreate icon to the left of the centered search box. Then click **+** at the bottom of the chat window:

   <img src="../agentic-toolbox-images/Attachment-icon.png" alt="Add context paperclip icon at the bottom of the Chat Panel" />

2. Choose the **Problems** option from the attachment menu:

   <img src="../agentic-toolbox-images/Problem-option.png" alt="Problems option selected in the Add context attachment menu" />
...
3. Select the problems to fix. You have two options:
   ...
   <img src="../agentic-toolbox-images/Problem-List.png" alt="List of problems available for selection in the Add context menu" />
...
4. Type a prompt in the chat to ask the agent to fix the selected problems. For example:
   ...
   <img src="../agentic-toolbox-images/Problem-context.png" alt="Chat Panel showing problems added as context with a prompt to fix them" />
...
1. Right-click the file in the **Explorer** and select **Add file to chat**:
   ...
   <img src="../agentic-toolbox-images/Context-option.png" alt="Add file to chat option in the Explorer right-click context menu" />
...
2. Select the file with errors from the list. It will be sent as context:
   ...
   <img src="../agentic-toolbox-images/file-context.png" alt="File selected from the Add context menu to send as context to the AI" />
...
3. Select your file from the list to send it as context:
   ...
   <img src="../agentic-toolbox-images/hash.png" alt="File list appearing after typing # in the Chat Panel input box" />
   ...
   <img src="../agentic-toolbox-images/file-context (2).png" alt="Chat Panel showing an attached file as context with a prompt to fix errors" />
