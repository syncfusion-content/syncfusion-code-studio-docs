---
title: BoldCreate Ask Mode
description: Ask Mode in BoldCreate provides AI-powered explanations, code examples, and best practices in a non-invasive conversational interface that does not modify workspace files.
...
- Launch BoldCreate IDE
- Select **Ask** from the agent dropdown menu in the chat panel

    <img src="../agentic-toolbox-images/ask1.png" alt="Ask Mode Selection" />
...
<img src="../agentic-toolbox-images/ask2.png" alt="Ask Mode Query Example" />

### Step 3: Review the Response

BoldCreate processes your query and returns:
...
<img src="../agentic-toolbox-images/ask.png" alt="Ask Mode Response Example" />
