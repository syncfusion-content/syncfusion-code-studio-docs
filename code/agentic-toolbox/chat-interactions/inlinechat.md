...
## Overview
Inline Chat in BoldCreate is designed to bring AI assistance directly into your workflow. Instead of switching panels or navigating away from your code, you can interact with AI right inside the editor or terminal. This seamless integration helps you stay focused, get context-aware suggestions, and streamline both coding and command-line tasks.
...
When you use Inline Chat inside the editor, BoldCreate scopes your request to the content in the active file. It may also use related files in your workspace to provide more accurate suggestions.

### How to Use Editor Inline Chat
**Steps:**
1. **Open a file** in the BoldCreate editor.
...
3. Type your request in the inline chat input box and press **Enter** to submit.
   ...
   <img src="../agentic-toolbox-images/inlinechat2.gif" alt="inlinechat"  />

> **Tip:** Select a block of code before opening Inline Chat if you want AI to focus on that part.

### Reviewing Suggestions
After processing your request, BoldCreate shows an inline diff view. You can:
- **Keep** the changes
- **Undo** the changes

  <img src="../agentic-toolbox-images/inlinechat3.png" alt="inlinechat"  />


## Using Inline Chat in the Terminal
Terminal Inline Chat helps you work with shell commands, scripts, and terminal workflows directly inside BoldCreate’s integrated terminal.
...
3. Type your command request and press **Enter**.
   ...
   <img src="../agentic-toolbox-images/inlinechat4.gif" alt="inlinechat"  />

### Running or Inserting Commands
After BoldCreate generates a shell command:
...
## Releted Features
- [Add context to your chat prompt](/code/agentic-toolbox/chat-interactions/add-context) - Enhance your prompt by providing extra details. This helps BoldCreate generate more accurate results and keeps your workspace aligned with your goals.
