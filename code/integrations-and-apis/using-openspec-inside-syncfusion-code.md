---
title: Using OpenSpec Inside BoldCreate Complete Guide
description: Learn how to use OpenSpec inside BoldCreate to propose, plan, build, and archive AI-powered code changes safely and predictably.
platform: syncfusion-code-studio
keywords: openspec, slash-commands, propose, apply, archive, explore
---

# Using OpenSpec Inside BoldCreate: A Complete Guide

## Overview 

This tutorial will guide you through using **OpenSpec** inside **BoldCreate** to create, plan, and execute AI (Artificial Intelligence)-assisted changes in a safe, structured, and predictable way. 
...
- **A project or folder** opened in BoldCreate (you can create an empty test folder if needed).
...
1. Open the integrated **Terminal** in BoldCreate by going to `View` > `Terminal` in the menu, or press `` Ctrl+` `` (Windows/Linux) or `` Cmd+` `` (Mac). Once the **Terminal** opens at the bottom of your BoldCreate window, type the following command and press `Enter` to install OpenSpec globally on your system:
...
openspec init
```
3. The initialization wizard will ask you to choose an AI extension. Since BoldCreate includes GitHub Copilot integration, select the **GitHub Copilot** option:

<img src="./integration-images/Extension-Option.png" alt="Select GitHub Copilot as your AI extension during OpenSpec initialization" />
...
Open the **Chat Panel** by pressing `Ctrl+Alt+B` (Windows/Linux) or `Cmd+Alt+B` (Mac), or click the BoldCreate icon in the toolbar. Then type `/opsx:explore` in the **Chat Panel** followed by your question. For example:

<img src="./integration-images/sf-icon.png" alt="BoldCreate chat icon in the toolbar" />

```
/opsx:explore Sales Dashboard using React
```

<img src="./integration-images/Explore-gif.gif" alt="Using the explore command to brainstorm ideas in the Chat Panel" />
...
<img src="./integration-images/Proposal.png" alt="Entering a propose command with requirements in the Chat Panel" />
...
<img src="./integration-images/Files-openpec.png" alt="The generated proposal, design, tasks, and spec files in the change folder" />
...
<img src="./integration-images/Apply-command.png" alt="Running the apply command to implement the planned changes" />
...
<img src="./integration-images/Archieve-command.png" alt="Running the archive command to finalize and organize completed work" />

Check your project structure to verify the archiving worked correctly:

<img src="./integration-images/main-spec.png" alt="The main spec folder showing finalized specifications after archiving" />
...
You've mastered the basics of OpenSpec in BoldCreate! Here are some recommended next steps to expand your skills:
