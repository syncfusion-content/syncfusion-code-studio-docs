...
<img src="../customize-images/mcp-server-webview.png" alt="custom server" />

**Step 3:** Click Add MCP Server. 

<img src="../customize-images/add-mcp-server.png" alt="custom server" />

Step 4: Review the Terms and Conditions, then click Accept and proceed. 

<img src="../customize-images/terms-and-conditions.png" alt="custom server" />
...
<img src="../customize-images/mcp-server-connection-types.png" alt="custom server" />
...
<img src="../customize-images/mcp-package-name.png" alt="custom server" />

**Step 7:** The Postman API key field will appear. Paste the Postman API key you generated and press Enter. 

<img src="../customize-images/mcp-package-api-key.png" alt="custom server" />
...
<img src="../customize-images/mcp-postman-tool-configuration.png" alt="custom server" />
...
<img src="../customize-images/mcp-workspace-option-choosing.png" alt="custom server" />

**Step 12:** The Postman MCP Server is now configured and ready to use. 

<img src="../customize-images/mcp-postman-installed.png" alt="custom server" />
...
<img src="../customize-images/custom-local-server.png" alt="custom server" />
...
<img src="../customize-images/agent_tool.png" alt="Tools" >
...
<img src="../customize-images/mcp-tools.png" alt="Tools" >
...
```
<img src="../customize-images/generate-test.png" alt="custom server" />
...
<img src="../customize-images/startserver.png" alt="custom server" />
