...
1. **Click** the Settings icon in the Chat window and **Select** **Agent Customizations**.
	...
	<img src="./customize-images/hookstart.png" alt="Chat settings menu in Syncfusion Code with the Settings icon highlighted" >
...
4. **Enter** a descriptive hook name and press Enter.
	...
	<img src="./customize-images/hookname.png" alt="Hook naming input field in Syncfusion Code" >
...
7. **Run** a test prompt to verify the hook is active.
	<img src="./customize-images/hookusing.gif" alt="Animated demonstration of creating and configuring a hook in Syncfusion Code" >
...
|---|---|---|
| Hook does not run | Incorrect event name, file path, or configuration placement | Verify `.sfcode/config.json`, event names, and referenced script paths |
