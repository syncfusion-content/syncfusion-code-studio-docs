---
title: BoldCreate Custom Agent
description: Custom Agent Mode in BoldCreate is an autonomous AI assistant that can analyze, edit, and execute changes across your codebase with minimal input.
...
Custom Agents are specialized versions of BoldCreate that deliver consistent expertise across end-to-end workflows. They are assigned to specific tasks and retain their configuration throughout the process. This reduces setup time, enforces team standards, and makes outcomes repeatable.
...
<img src="./customize-images/new_custom_agent.png" alt="new_Custom_Agent" />

- Click “+ Create new Custom agent”

<img src="./customize-images/agen-create.png" alt="Custom_Agent" />

**Method 2 – Through Command Palette**
- Press `Ctrl+Shift+P` (Windows/Linux) or `⌘⇧P` (Mac)
- Type **"Chat: New Custom Agent"** → press Enter

<img src="./customize-images/agent_palette.png" alt="agent_palette" />

**Method 3 – Through Settings**
- Open Settings (top-right in chat view)

<img src="./customize-images/agent_option.png" alt="agent_option" />

- Choose **Agent Customizations** from the menu
- Click “Generate Agent”

<img src="./customize-images/custom_agent.png" alt="Custom_Agent" />

### Step 2: Choose Where to Save Your Agent

**Option 1: Workspace** (recommended for team sharing)
- Saves to: `YOUR-PROJECT/.boldcreate/agents/` folder in your project.
- Use when: Sharing with your **team** while committing your source.
- Location: `YOUR-PROJECT/.boldcreate/agents/your-agent-name.agent.md`
...
<img src="./customize-images/agent_save.png" alt="agent_save" />
...
<img src="./customize-images/agent_review.png" alt="agent_review" />
...
<img src="./customize-images/agent_code_review.png" alt="agent_code_review" />
...
<img src="./customize-images/agent_code_header.png" alt="agent_code_header" />
...
- BoldCreate automatically detects the new agent.
- Open Chat view and click the agent dropdown.
- Your new agent appears in the list.

<img src="./customize-images/agent_activate.png" alt="agent_activate" />

## Using Your Custom Agents

**To Use the CodeReview Agent:**
- Open Chat view in BoldCreate.
- Click the agent dropdown.

<img src="./customize-images/agent_dropdown_option.png" alt="agent_dropdown_option" />
...
<img src="./customize-images/agent_chatting.png" alt="agent_chatting" />

**To Edit the CodeReview Agent:**
- Click agent dropdown.
- Select **Configure Custom Agents**.

<img src="./customize-images/agent_configure_chat.png" alt="agent_configure_chat" />
...
- Add a **hooks** field to the YAML frontmatter of your `.agent.md` file, using the same event names and command structure as workspace-level hooks.
  ...
  <img src="./customize-images/agent-scoped-hooks.png" alt="agent_configure_chat" />
...
3. **Add to Your Project**: Place files in `YOUR-PROJECT/.boldcreate/agents/` folder
