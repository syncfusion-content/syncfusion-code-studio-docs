...
| ------------------------------------------------- | --------------------------------------------------------------------------------------- |
| **Project Skills** (stored in the repository)     | `.sfcode/skills/`, `.github/skills/`, `.claude/skills/`, `.agents/skills/`          |
| **Personal Skills** (stored in your user profile) | `~/.sfcode/skills/`, `~/.copilot/skills/`, `~/.claude/skills/`, `~/.agents/skills/` |
