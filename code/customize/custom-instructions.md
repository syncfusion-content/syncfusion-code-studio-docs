...
description: Details about configuring rules that define the behavior and constraints for language models in BoldCreate IDE.
platform: syncfusion-code-studio
control: IDE
documentation: Getting Started
keywords: boldcreate, IDE, installation, windows, setup, getting-started
---
...
Custom Instructions allow you to define guidelines and rules that automatically influence how the AI generates code and handles development tasks in BoldCreate.
...
- **File Type:** `boldcreate-instructions.md`  
- **Location:** `.boldcreate/boldcreate-instructions.md` (at the project root)
...
- **Location:** `.boldcreate/instructions/`  
  - Example: `.boldcreate/instructions/python.instructions.md`  
  - Example: `.boldcreate/instructions/frontend.instructions.md`
...
**Step 1:** Open **settings** at the bottom left in BoldCreate.  

<img src="./customize-images/instruction_option.png" alt="instruction_option" >

**Step 2:** Select **BoldCreate Settings** in the pop-up options.

<img src="./customize-images/instruction_boldcreate_settings.png" alt="instruction_boldcreate_settings" >

**Step 3:** Click **Instructions & Skills** in the settings options.

<img src="./customize-images/instruction_repo.png" alt="instruction_repo" >
...
- **Option 1: Project-wise instructions** 
    ...
    <img src="./customize-images/instruction_repo_path.png" alt="instruction_path" >
...
- **Option 2: Path-specific instructions**
    ...
    <img src="./customize-images/instruction_specific_path.png" alt="instruction_specific_path" >

- **Option 3: Add New Path-specific Location**
    - Click the **Add New Location** in the instruction settings page.
    
    <img src="./customize-images/instruction_new_location.png" alt="instruction_new_location" >

    - You can add a new custom file path and switch **ON** the path specific settings.

    <img src="./customize-images/instruction_path_add.png" alt="instruction_path_add" >
...
**Step 1:** Open the `boldcreate-instructions.md` file.

- Open your project in BoldCreate. Click the settings option at the top in the chat and select **agent customizations**.

    <img src="./customize-images/instruction_chat_option.png" alt="instruction_chat_option" >

- Click the “Generate instructions” and select New instruction(workspace) in the pop up.

**Step 2:** Now BoldCreate will automatically create and open `boldcreate-instructions.md`.  

<img src="./customize-images/instruction_repo_file.png" alt="instruction_repo_file">
...
<img src="./customize-images/instruction_repo_refer.png" alt="instruction_repo_refer">


## How to Configure Path-specific Instruction File

**Step 1:** Click *Settings* from the top right and click **Open settings**
<img src="./customize-images/settings-account.png" alt="instruction_path_chat">

**Step 2:** Click **Instruction & SKills** and select **Add Location**
<img src="./customize-images/instruction_path_chat.png" alt="instruction_path_chat">

**Step 2:** Enter **Name for Instruction File**.

<img src="./customize-images/instruction_path_new_chat.png" alt="instruction_path_new_chat">
...
- There are two options to save your instruction. You can choose any one of them based on your preference.
    ...
    - **Option 1: Workspace:** 
        - Save to `.boldcreate/instructions/` folder in your project.
        - Use when: Sharing with your **team** while committing your source.
        - Location: `YOUR-PROJECT/.boldcreate/instructions instruction-name.instructions.md`.
    - **Option 2: User Profile:**
        ...
        <img src="./customize-images/instruction_path_workspace.png" alt="instruction_path_workspace">
...
<img src="./customize-images/instruction_path_name.png" alt="instruction_path_name">

**Step 5:** The new file will be open automatically for editing.

<img src="./customize-images/instruction_path_test.png" alt="instruction_path_test">
...
- Steps to target the global path:
    ...
    <img src="./customize-images/instruction_global.png" alt="instruction_global" >

    - Step 2: Add instructions in the test-instructions.md.

    <img src="./customize-images/instruction_global_test.png" alt="instruction_global_test" >

    - Step 3: Open chat and send message your instruction will come in the **used reference.**

    <img src="./customize-images/instruction_path_result.png" alt="instruction_global_result" >
...
- Steps to target the pattern specific path
    ...
    <img src="./customize-images/instruction_path_apply.png" alt="instruction_path_apply" >

    - Step 2: Add instructions in the test-instructions.md.

    <img src="./customize-images/instruction_path_rules.png" alt="instruction_path_rules" >

    - Step 3: Include the file in the **chat context** which you want to edit.

    <img src="./customize-images/instruction_path_context.png" alt="instruction_path_context" >
