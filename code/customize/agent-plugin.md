...
description: Learn how to configure and control agent autonomy in Syncfusion Code using the new Autopilot and permissions picker. This tutorial walks you through enabling Autopilot with chat.autopilot.enabled, choosing between Default Approvals, Bypass Approvals, or Autopilot (Preview), and understanding the security implications of each mode
...
- **[Agent Skills](/code-studio/customize/skills)**: Learn how to create reusable, specialized tasks for agents. 

- **[Custom Agents](/code-studio/customize/custom-agents)**: Understand how to build domain-specific AI personas. 

- **[MCP Servers](/code-studio/customize/mcp/customservers)**: Discover how to integrate mcp tools and data sources. 
