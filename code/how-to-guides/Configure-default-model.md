...
* Go to the [Models](https://app.sfcodestudio.com/models) section and click Manage Default Settings.
 ...
 >**Note**: If you have not configured your model, please refer to [Configure LLM Providers and Models in Syncfusion Code](/code-studio/enterprise-server/providersandmodels) for guidance on adding models.
...
* You have successfully configured your default models! Your selected models will now appear automatically when you launch Syncfusion Code IDE. 
    ...
    <img src="./howtoguide-images/code-model.png" alt="cache">
