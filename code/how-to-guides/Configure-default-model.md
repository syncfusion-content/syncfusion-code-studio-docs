...
* Go to the [Models](https://app.sfcodestudio.com/models) section and click Manage Default Settings.
 ...
 >**Note**: If you have not configured your model, please refer to [Configure LLM Providers and Models in Syncfusion Code](/code/enterprise-server/providersandmodels) for guidance on adding models.
