...
description: Learn how to identify, review, and resolve issues that occurred in earlier chat sessions within BoldCreate. This tutorial guides you through accessing past conversations, diagnosing common problems, and applying corrective steps to ensure smooth continuity in your development workflow.
...
- Search for ` syncfusion.code.chat.agentDebugLog.fileLogging.enabled ` 

- Toggle the setting to On for persistent file logging 

    <img src="./troubleshoot-images/settings-enable.png" alt="Agent Debug Log Enable" />
...
- Open the Chat view in BoldCreate. This will be your current troubleshooting session where you'll diagnose past issues 

- In the chat input field, type: `/troubleshoot` command is recognized 
    <img src="./troubleshoot-images/chat-troubleshoot.png" alt="Troubleshoot Previous session with Agent Debug log" />
...
- A session picker dialog will appear showing your previous chat sessions 
    <img src="./troubleshoot-images/chat-troubleshoot-session.png" alt="Troubleshoot Previous session with Agent Debug log" />
...
Once you submit your troubleshooting query, BoldCreate will analyze the debug logs from the selected session and provide insights such as: 
...
The troubleshoot skill will parse agent debug logs and return insights which tool calls ran, where custom instructions were ignored, or latency sources. Use these insights to adjust settings or reproduce the issue if needed.
    <img src="./troubleshoot-images/troubleshoot-gif.gif" alt="Troubleshoot Previous session with Agent Debug log" />
